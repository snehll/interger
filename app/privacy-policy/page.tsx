    ...
    <article className="py-24 bg-background">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert space-y-8 text-muted-foreground">
          <p>
            This Privacy Policy describes how <strong>Integer WW FZ-LLC</strong>
            , a company duly organized and existing under the laws of the United
          ...
          <p>
            ...
            to authorized personnel of Integer WW FZ-LLC for the purposes stated
            in this Policy.
          </p>
